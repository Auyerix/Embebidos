...
int main(void)
{
  ...
  //Lo genero para apuntarle solo a la pantalla direccion 0x4E 1001110 (en 8 bits agrega el 0) el numero que detecta es el 0x27 = 100111
  //test = HAL_I2C_IsDeviceReady(&hi2c1, 0x4E, 3, 5);
// BMP180 0xEE da cero es decir està ok... detecta 0x77 01110111 que al agregarle un cero a la derecha de 11101110 que es 0xEE
  test = HAL_I2C_IsDeviceReady(&hi2c1, 0xEE, 3, 5);
  ...
  //chip_ID = Get_ID (); // función de chequeo
